...
function SWEP:PrimaryAttack()
	...
	self:SetNextPrimaryAttack(CurTime() + 3 / (owner.ZombieAttackMultiplier or 1))
	...
	if SERVER then
		...
		owner:GodEnable()
		util.BlastDamageEx(self, owner, owner:GetShootPos(), 57, 5 * (owner.ZombieDamageMultiplier or 1), DMG_DROWN)
		owner:GodDisable()
	end
