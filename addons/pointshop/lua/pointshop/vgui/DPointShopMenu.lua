...
function PANEL:Init()
	...
	for _, CATEGORY in pairs(categories) do
		...
		ShopCategoryTabLayout:SetBorder(5)
		ShopCategoryTabLayout:SetSpaceX(5)
		ShopCategoryTabLayout:SetSpaceY(0)
...
function PANEL:Paint(w, h)
	...
	if PS.Config.CommunityName then
		draw.SimpleText(PS.Config.CommunityName .. " PointShop", 'PS_LargeTitle', 16, 8, color_red)
	else
		draw.SimpleText("PointShop", 'PS_LargeTitle', 16, 8, color_red)
	end

	draw.SimpleText('You have ' .. LocalPlayer():GetPoints() .. ' ' .. PS.Config.PointsName, 'PS_Heading3', self:GetWide() - 40, 24, color_white, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
