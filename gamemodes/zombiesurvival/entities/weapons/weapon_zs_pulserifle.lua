...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'Geiger-Müller' Particle Rifle", "Shoots irradiated particles that deal area damage but do not slow", function(wept)	
