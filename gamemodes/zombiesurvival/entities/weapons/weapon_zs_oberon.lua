...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'Becquerel' Radiation Sprayer", "Shoots irradiated particles that deal area damage but do not slow", function(wept)	
	wept.Primary.Damage = 36
    ...
    function wept.BulletCallback(attacker, tr, dmginfo)
		...
		attacker:LagCompensation(true)
      	...
      	if ent:IsValidZombie() then
			util.BlastDamageEx(attacker:GetActiveWeapon(), attacker, ent:GetPos(), 88, wept.Primary.Damage, DMG_DISSOLVE, 0.94)
		end
