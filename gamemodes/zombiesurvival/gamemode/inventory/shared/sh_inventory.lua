...
-- Health Trinkets
trinket, trinketwep = GM:AddTrinket("Health Package", "vitpackagei", false, hpveles, hpweles, 1, "+10 maximum health\n+5% healing received")
GM:AddSkillModifier(trinket, SKILLMOD_HEALTH, 10)
GM:AddSkillModifier(trinket, SKILLMOD_HEALING_RECEIVED, 0.05)
trinketwep.PermitDismantle = true

trinket = GM:AddTrinket("Vitality Bank", "vitpackageii", false, hpveles, hpweles, 1, "+21 maximum health\n+6% healing received")
GM:AddSkillModifier(trinket, SKILLMOD_HEALTH, 21)
GM:AddSkillModifier(trinket, SKILLMOD_HEALING_RECEIVED, 0.06)

trinket, trinketwep = GM:AddTrinket("Blood Transfusion Pack", "bloodpack", false, hpveles, hpweles, 1, "Generates 20 blood armor if health falls bellow 50%\nConsumes itself on activation.", nil, 15)
trinketwep.PermitDismantle = true

trinket, trinketwep = GM:AddTrinket("Blood Package", "cardpackagei", false, hpveles, hpweles, 1, "+10 maximum blood armor")
GM:AddSkillModifier(trinket, SKILLMOD_BLOODARMOR, 10)
trinketwep.PermitDismantle = true

GM:AddSkillModifier(GM:AddTrinket("Blood Bank", "cardpackageii", false, hpveles, hpweles, 1, "+30 maximum blood armor"), SKILLMOD_BLOODARMOR, 30)

GM:AddTrinket("Regeneration Implant", "regenimplant", false, hpveles, hpweles, 1, "Heals 1 health every 12 seconds provided no damage was taken recently")

GM:AddTrinket("Life Steal", "lifesteal", false, hpveles, hpweles, 1, "Heals you by a percentage of the damage you deal to zombies. Less effective the further they are")


trinket, trinketwep = GM:AddTrinket("Bio Cleanser", "biocleanser", false, hpveles, hpweles, 1, "Blocks one harmful status effect every 20 seconds")
trinketwep.PermitDismantle = true
...
trinket, trinketwep = GM:AddTrinket("Momentum Support", "momentumsupsysii", false, mveles, mweles, 1, "-13% melee swing impact delay\n+10% melee knockback")
...
trinket = GM:AddTrinket("Momentum Scaffold", "momentumsupsysiii", false, mveles, mweles, 1, "-20% melee swing impact delay\n+12% melee knockback")
...
trinket = GM:AddTrinket("Hemo-Adrenaline Amplifier", "hemoadrenalii", false, mveles, mweles, 1, "+3% melee damage converted to blood armor\n+30 speed on melee kill for 10 seconds")
...
GM:AddSkillModifier(GM:AddTrinket("Hemo-Adrenal Converter II", "hemoadrenaliii", false, mveles, mweles, 1, "+4% melee damage converted to blood armor."), SKILLMOD_MELEE_DAMAGE_TO_BLOODARMOR_MUL, 0.04)

GM:AddSkillModifier(GM:AddTrinket("Power Gauntlet", "powergauntlet", false, mveles, mweles, 1, "Charges your melee damage up to +45% with each hit\nMissing resets damage"), SKILLMOD_MELEE_POWERATTACK_MUL, 0.45)

GM:AddTrinket("Finesse Kit", "sharpkit", false, mveles, mweles, 1, "Deal up to +32% melee damage to slowed zombies")

GM:AddTrinket("Sharp Stone", "sharpstone", false, mveles, mweles, 1, "+5% melee damage")
...
trinket = GM:AddTrinket("Galvanizer Implant", "analgestic", false, pveles, pweles, 1, "-50% low health slow intensity\n-50% slow vulnerability\n-50% knockdown time\n-66% duration of pulling attacks\n+25% weapon switch speed")
...
GM:AddSkillModifier(GM:AddTrinket("Ammo Vest", "ammovestii", false, ammoveles, ammoweles, 1, "+5% reload speed"), SKILLMOD_RELOADSPEED_MUL, 0.05)
GM:AddSkillModifier(GM:AddTrinket("Ammo Bandolier", "ammovestiii", false, ammoveles, ammoweles, 1, "+12% reload speed"), SKILLMOD_RELOADSPEED_MUL, 0.12)

GM:AddTrinket("Automated Reloader", "autoreload", false, ammoveles, ammoweles, 1, "Reloads one weapon you switched away from 4 seconds ago automatically")
...
GM:AddSkillModifier(GM:AddTrinket("Targeting Unifier", "targetingvisoriii", false, oveles, oweles, 1, "+11% tighter aiming reticule."), SKILLMOD_AIMSPREAD_MUL, -0.11)

GM:AddTrinket("Refined Subscope", "refinedsub", false, oveles, oweles, 1, "+27% tighter aiming reticule with tier 3 or lower weapons")

trinket = GM:AddTrinket("Aim Compensator", "aimcomp", false, oveles, oweles, 1, "-52% reduced effect of aim shake effects\n+5% tighter aiming reticule\nZombies you look at have an indicator showing their health")
...
trinket = GM:AddTrinket("Pulse Infuser", "pulseampii", false, oveles, oweles, 1, "+20% slow from pulse weapons and stun batons\n+7% explosion radius")
...
trinket = GM:AddTrinket("Resonance Cascade Device", "resonance", false, oveles, oweles, 1, "Dealing enough pulse damage will cause a pulse explosion\n-25% slow from pulse weapons and stun batons")
GM:AddSkillModifier(trinket, SKILLMOD_PULSE_WEAPON_SLOW_MUL, -0.25)

trinket = GM:AddTrinket("Cryogenic Inductor", "cryoindu", false, oveles, oweles, 1, "Ice based weapons have a chance to shatter zombies based on how much health they have")

trinket = GM:AddTrinket("Extended Magazine", "extendedmag", false, oveles, oweles, 1, "Increases the clip size of weapons with 8 or more clip size by +15%")

trinket = GM:AddTrinket("Pulse Impedance Module", "pulseimpedance", false, oveles, oweles, 1, "Slow from pulse weapons and stun batons also slow zombie attack speed\n+24% slow from pulse weapons and stun batons")
...
trinket = GM:AddTrinket("Curb Stompers", "curbstompers", false, oveles, oweles, 1, "Instantly kills headcrabs and deals 50 damage to torso classes you land on\nDeals 500% fall damage to zombies landed on\nNo fall damage taken when landing on zombies\n-25% slow down from landing or fall damage")
...
trinket = GM:AddTrinket("Olympian Frame", "olympianframe", false, oveles, oweles, 1, "+100% object throwing strength\n-25% prop carrying slow down\n-35% movement speed reduction with heavy weapons")
...
-- Defensive Trinkets
trinket, trinketwep = GM:AddTrinket("Kevlar Underlay", "kevlar", false, develes, deweles, 1, "-11% melee damage taken\n-11% projectile damage taken")
...
trinket = GM:AddTrinket("Barbed Armor", "barbedarmor", false, develes, deweles, 1, "100% of melee damage taken reflected back to melee attackers\nAdditional 14 damage reflected back to melee attackers\nMelee attackers take 14 arm damage\n-4% melee damage taken")
...
trinket = GM:AddTrinket("Antitoxin Package", "antitoxinpack", false, develes, deweles, 1, "-17% poison damage taken\n-40% poison damage over time speed")
...
trinket = GM:AddTrinket("Hemostasis Implant", "hemostasis", false, develes, deweles, 1, "-30% bleed damage taken\n-60% bleeding speed.")
GM:AddSkillModifier(trinket, SKILLMOD_BLEED_DAMAGE_TAKEN_MUL, -0.3)
GM:AddSkillModifier(trinket, SKILLMOD_BLEED_SPEED_MUL, -0.6)

trinket = GM:AddTrinket("EOD Vest", "eodvest", false, develes, deweles, 1, "-35% explosive damage taken\n-50% fire damage taken\n-5% self damage taken")
...
trinket = GM:AddTrinket("Feather Fall Frame", "featherfallframe", false, develes, deweles, 1, "-35% fall damage taken\n+30% fall damage threshold\n-65% slow down from landing or fall damage")
...
GM:AddSkillModifier(GM:AddTrinket("Force Dampening Field Emitter", "forcedamp", false, develes, deweles, 1, "-33% physics impact damage taken\nImmune to knockdowns from props\nTake normal physics damage from shades."), SKILLMOD_PHYSICS_DAMAGE_TAKEN_MUL, -0.33)

GM:AddSkillFunction(GM:AddTrinket("Necrotic Senses Distorter", "necrosense", false, develes, deweles, 1, "Hides aura from zombies in close proximity"), function(pl, active) pl:SetDTBool(DT_PLAYER_BOOL_NECRO, active) end)

trinket, trinketwep = GM:AddTrinket("Reactive Flasher", "reactiveflasher", false, develes, deweles, 1, "Blinds and disorients melee attacker for 2 seconds\nRecharges every 75 seconds")
trinketwep.PermitDismantle = true

trinket = GM:AddTrinket("Composite Underlay", "composite", false, develes, deweles, 1, "-16% melee damage taken\n-16% projectile damage taken")
...
trinket, trinketwep = GM:AddTrinket("Arsenal Pack", "arsenalpack", false, {
	...
	["base"] = { type = "Model", model = "models/Items/item_item_crate.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 2, -1), angle = Angle(0, -90, 180), size = Vector(0.35, 0.35, 0.35), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}, 1, "Allows nearby humans to purchase from the arsenal menu.", "arsenalpack", 3)
trinketwep.PermitDismantle = true
...
trinket, trinketwep = GM:AddTrinket("Loading Exoskeleton", "loadingex", false, supveles, supweles, 1, "-55% prop carrying slow down\n-20% deployable pack time")
...
trinket, trinketwep = GM:AddTrinket("Blueprints", "blueprintsi", false, supveles, supweles, 1, "+35% repair rate")
GM:AddSkillModifier(trinket, SKILLMOD_REPAIRRATE_MUL, 0.35)
trinketwep.PermitDismantle = true

GM:AddSkillModifier(GM:AddTrinket("Advanced Blueprints", "blueprintsii", false, supveles, supweles, 1, "+20% repair rate"), SKILLMOD_REPAIRRATE_MUL, 0.2)

trinket, trinketwep = GM:AddTrinket("Medical Processor", "processor", false, supveles, supweles, 1, "-5% medic kit cooldown\n-10% medic tool fire delay\nReprocess food into medical ammo with right click")
...
trinket = GM:AddTrinket("Curative Kit", "curativeii", false, supveles, supweles, 1, "-10% medic kit cooldown\n-20% medic tool fire delay")
...
trinket = GM:AddTrinket("Remedial Booster", "remedy", false, supveles, supweles, 1, "+8% medic tool effectiveness")
GM:AddSkillModifier(trinket, SKILLMOD_MEDKIT_EFFECTIVENESS_MUL, 0.08)

trinket = GM:AddTrinket("Maintenance Suite", "mainsuite", false, supveles, supweles, 1, "+10% zapper and repair field range\n-7% zapper and repair field delay\n+10% turret range")
...
trinket = GM:AddTrinket("Control Platform", "controlplat", false, supveles, supweles, 1, "+15% controllable health\n+15% controllable speed\n+20% manhack damage")
...
trinket = GM:AddTrinket("Projectile Guidance", "projguide", false, supveles, supweles, 1, "+25% projectile speed")
GM:AddSkillModifier(trinket, SKILLMOD_PROJ_SPEED, 0.25)

trinket = GM:AddTrinket("Projectile Weight", "projwei", false, supveles, supweles, 1, "-50% projectile speed\n+5% projectile damage")
...
trinket = GM:AddTrinket("Reactive Chemicals", "reachem", false, ectov, ectow, 1, "+30% explosive damage taken\n+10% explosive damage radius")
GM:AddSkillModifier(trinket, SKILLMOD_EXP_DAMAGE_TAKEN_MUL, 0.3)
GM:AddSkillModifier(trinket, SKILLMOD_EXP_DAMAGE_RADIUS, 0.1)

trinket = GM:AddTrinket("Operations Matrix", "opsmatrix", false, supveles, supweles, 1, "+15% zapper and repair field range\n-13% zapper and repair field delay\n+15% turret range")
...
GM:AddSkillModifier(GM:AddTrinket("Acquisitions Manifest", "acqmanifest", false, supveles, supweles, 1, "-6% resupply delay time"), SKILLMOD_RESUPPLY_DELAY_MUL, -0.06)
GM:AddSkillModifier(GM:AddTrinket("Procurement Manifest", "promanifest", false, supveles, supweles, 1, "-9% resupply delay time"), SKILLMOD_RESUPPLY_DELAY_MUL, -0.09)
