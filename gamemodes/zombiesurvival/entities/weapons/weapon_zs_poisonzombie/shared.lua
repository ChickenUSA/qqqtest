...
function SWEP:SecondaryAttack()
	...
	self:SetNextSecondaryFire(time + self.Secondary.Delay / (owner.ZombieAttackMultiplier or 1))
	self:SetNextPrimaryFire(time + self.Primary.Delay / (owner.ZombieAttackMultiplier or 1))
