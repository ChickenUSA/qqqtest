...
local function ItemPanelDoClick(self)
	...
	local alreadySelected = sweptable and viewer.m_Title:GetText() == sweptable.PrintName

	if not sweptable or GAMEMODE.AlwaysQuickBuy or alreadySelected then
...
function GM:OpenArsenalMenu()
	...
	local wsb = EasyButton(topspace, "Remantler Menu", 8, 4)
	...
	for catid, catname in ipairs(GAMEMODE.ItemCategories) do
    	if catname == "Trinkets" then continue end
