...
function SWEP:PrimaryAttack()
	...
	self:SetNextLeap(CurTime() + self.PounceWindUp / (owner.ZombieAttackMultiplier or 1))
...
function SWEP:SecondaryAttack()
	...
	self:SetNextSpit(CurTime() + self.SpitWindUp / (owner.ZombieAttackMultiplier or 1))
...
function SWEP:Reload()
	...
	local owner = self:GetOwner()
	self:SetNextReload(CurTime() + self.SilentPounceWindUp / (owner.ZombieAttackMultiplier or 1))
