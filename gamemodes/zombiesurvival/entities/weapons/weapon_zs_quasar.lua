...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'Cherenkov' Beam Rifle", "Shoots a beam of radiation that deals area damage but doesn't penetrate", function(wept)
	wept.Penetration = 0
	wept.Pierces = 0
