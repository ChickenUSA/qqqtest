...
GM.DamageHUD2D = CreateClientConVar("zs_2ddamagehud", "1", true, false):GetBool()
cvars.AddChangeCallback("zs_2ddamagehud", function(cvar, oldvalue, newvalue)
	GAMEMODE.DamageHUD2D = tonumber(newvalue) == 1
end)
