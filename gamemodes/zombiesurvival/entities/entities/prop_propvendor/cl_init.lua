...
function ENT:Initialize()
	self:SetRenderBounds(Vector(0, 0, 0), Vector(256, 256, 256))
end
...
function ENT:RenderInfo(pos, ang, owner)
	cam.Start3D2D(pos, ang, 0.055)
		draw.SimpleText(translate.Get("weapon_propvendor"), "ZS3D2DFont2", 0, -50, COLOR_GREEN, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
