...
hook.Add("PlayerDisconnected", "Propvendor.PlayerDisconnected", RefreshRemantlerOwners)
hook.Add("OnPlayerChangedTeam", "Propvendor.OnPlayerChangedTeam", RefreshRemantlerOwners)
...
function ENT:OnPackedUp(pl)
	pl:GiveEmptyWeapon("weapon_zs_propvendor")
	pl:GiveAmmo(1, "propvendor")
...
function ENT:Use(activator, caller)
	...
	activator:SendLua("GAMEMODE:OpenPropvendorMenu(MySelf:NearestPropvendor())")
end
