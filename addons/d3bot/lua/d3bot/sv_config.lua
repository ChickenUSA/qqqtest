...
D3bot.ZombiesPerPlayer = 0.0
D3bot.ZombiesPerPlayerMax = 100.0			-- Limits amount of zombies to this zombie/player ratio. (ZombiesCountAddition is not calculated in)
D3bot.ZombiesPerPlayerWave = 0
D3bot.ZombiesPerMinute = 0
D3bot.ZombiesPerWave = 2.6
...
D3bot.SelfRedeemWaveMax = 6				-- The maximum wave a player can respawn (Setting it to 2 would allow the players to redeem in the first and second wave)
...
D3bot.BotKickReason = "Kicked for bot activities"
