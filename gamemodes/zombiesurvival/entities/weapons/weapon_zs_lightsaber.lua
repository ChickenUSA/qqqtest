...
SWEP.PrintName = "'The Chosen One' Lightsaber"
SWEP.Description = "Can cleave through multiple droids in one swing." 
...
if CLIENT then
	...
	SWEP.WElements = {
	["base"] = { type = "Model", model = "models/weapons/tfa_cso/w_beam_sword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, .8, -2), angle = Angle(180, 0, 0), size = Vector(1.2, 1.2, 1.8), color = Color(255, 255, 255, 255), surpresslightning = false, skin = 0, bodygroup = {} },
	}
...
function SWEP:PlaySwingSound()
	self:EmitSound("weapons/tfa_cso/beamsword/midslash2.wav", 75, math.random(65, 85))
end

function SWEP:PlayHitSound()
	self:EmitSound("weapons/tfa_cso/beamsword/hit_wall_2.wav"..math.random(4)..".wav", 75)
end
