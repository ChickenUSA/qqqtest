...
SKILL_ZGRASP2 = 159
SKILL_ZGRASP3 = 160
SKILL_ZENDURING1 = 161
SKILL_ZENDURING2 = 162
SKILL_ZENDURING3 =163
SKILL_ZFURY1 = 164
SKILL_ZFURY2 = 165
SKILL_ZFURY3 = 166
SKILL_ZSUPERZOMBIE = 167
...
SKILLMOD_MELEE_SWING_SPEED_MUL = 100
SKILLMOD_ZOMBIEHEALTH_MUL = 101
SKILLMOD_ZOMBIESPEED_MUL = 102
SKILLMOD_ZOMBIEDAMAGE_MUL = 103
SKILLMOD_ZOMBIERANGE_MUL = 104
SKILLMOD_ZOMBIERESISTANCE_MUL = 105
SKILLMOD_ZOMBIEATTACK_MUL = 106
...
GM:AddSkill(SKILL_SPEED1, "Speed I", GOOD.."+0.75 movement speed\n",
																-6,			-4,					{SKILL_NONE, SKILL_SPEED2}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_SPEED3, "Speed III", GOOD.."+3 movement speed\n"..BAD.."-2 maximum health",
																-2,			-4,					{SKILL_SPEED4}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_SPEED4, "Speed IV", GOOD.."+4.5 movement speed\n"..BAD.."-4 maximum health",
																0,			-4,					{SKILL_SPEED5, SKILL_SAFEFALL}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_SPEED5, "Speed V", GOOD.."+5.25 movement speed\n"..BAD.."-5 maximum health",
																2,			-4,					{SKILL_ULTRANIMBLE, SKILL_BACKPEDDLER, SKILL_MOTIONI, SKILL_CARDIOTONIC, SKILL_UNBOUND}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_AGILEI, "Agile I", GOOD.."+4% jumping power\n"..BAD.."-1 movement speed",
																-6,			4,					{SKILL_NONE, SKILL_AGILEII}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_AGILEII, "Agile II", GOOD.."+5% jumping power\n"..BAD.."-2 movement speed",
																-2,			4,					{SKILL_AGILEIII--[[, SKILL_WORTHINESS3]]}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_AGILEIII, "Agile III", GOOD.."+6% jumping power\n"..BAD.."-3 movement speed",
																2,			4,					{SKILL_SAFEFALL, SKILL_ULTRANIMBLE, SKILL_SURESTEP, SKILL_INTREPID}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_MOTIONII, "Motion II", GOOD.."+0.75 movement speed",
																2,			0,					{SKILL_MOTIONIII}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_MOTIONIII, "Motion III", GOOD.."+0.75 movement speed",
																4,			0,					{--[[SKILL_D_SLOW]]}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_BACKPEDDLER, "Backpeddler", GOOD.."Move the same speed in all directions\n"..BAD.."-7 movement speed\n"..BAD.."Receive leg damage on any melee hit",
																0,			-6,					{}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_PHASER, "Phaser", GOOD.."+25% barricade phasing movement speed\n"..BAD.."+50% sigil teleportation time",
																-4,			-1,					{--[[SKILL_D_WIDELOAD,]] SKILL_DRIFT}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_DRIFT, "Drift", GOOD.."+10% barricade phasing movement speed",
																-3,			1,					{SKILL_WARP}, TREE_SPEEDTREE)
GM:AddSkill(SKILL_WARP, "Warp", GOOD.."-15% sigil teleportation time",
																-2,			2,					{}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_INTREPID, "Intrepid", GOOD.."-35% low health slow intensity\n"..BAD.."-4 movement speed",
																4,			6,					{SKILL_ROBUST}, TREE_SPEEDTREE)
...
GM:AddSkill(SKILL_SURGEON3, "Surgeon III", GOOD.."-10% medical kit cooldown",
																-2,			0,					{--[[SKILL_U_MEDICCLOUD,]] SKILL_DISPERSION, --[[SKILL_D_FRAIL,]] SKILL_SURGEONIV}, TREE_SUPPORTTREE)
...
GM:AddSkill(SKILL_BIOLOGYIII, "Biology III", GOOD.."+10% medic tool effectiveness",
																2,			0,					{--[[SKILL_U_MEDICCLOUD, SKILL_U_ANTITODESHOT,]] SKILL_DISPERSION, SKILL_BIOLOGYIV}, TREE_SUPPORTTREE)
...
--																4,			-2,					{}, TREE_SUPPORTTREE)
GM:AddSkill(SKILL_DISPERSION, "Dispersion", GOOD.."+25% cloud bomb radius\n"..BAD.."-10% cloud bomb time",
																0,			-4,					{}, TREE_SUPPORTTREE)

-- Defence Tree
GM:AddSkill(SKILL_HANDY1, "Handy I", GOOD.."+4% repair rate",
																6,			5,					{SKILL_NONE, SKILL_HANDY2}, TREE_BUILDINGTREE)
GM:AddSkill(SKILL_HANDY2, "Handy II", GOOD.."+5% repair rate",
																4,			5,					{SKILL_HANDY3, SKILL_TURRETLOCK, SKILL_TWINVOLLEY, SKILL_TURRETOVERLOAD, SKILL_LOADEDHULL}, TREE_BUILDINGTREE)
GM:AddSkill(SKILL_HANDY3, "Handy III", GOOD.."+6% repair rate",
																1,			5,					{SKILL_TAUT, SKILL_HAMMERDISCIPLINE, --[[SKILL_D_NOODLEARMS,]] SKILL_HANDY4}, TREE_BUILDINGTREE)
GM:AddSkill(SKILL_HANDY4, "Handy IV", GOOD.."+7% repair rate",
																-1,			3,					{SKILL_HANDY5}, TREE_BUILDINGTREE)
...
GM:AddSkill(SKILL_HAMMERDISCIPLINE, "Hammer Discipline", GOOD.."-20% swing delay with the Carpenter Hammer",
																-1,			0,					{SKILL_BARRICADEEXPERT}, TREE_BUILDINGTREE)
...
GM:AddSkill(SKILL_LOADEDHULL, "Loaded Hull", GOOD.."Controllables explode when destroyed, dealing explosive damage\n"..BAD.."-10% Controllable health",
																4,			2,					{SKILL_REINFORCEDHULL, SKILL_REINFORCEDBLADES, SKILL_AVIATOR}, TREE_BUILDINGTREE)
...
GM:AddSkill(SKILL_ACUITY, "Supplier's Acuity", GOOD.."Locate nearby resupply boxes if behind walls\n"..GOOD.."Locate nearby unplaced resupply boxes on players through walls\n"..GOOD.."Locate nearby resupply packs through walls",
																3,			-4,					{SKILL_INSIGHT, SKILL_STOCKPILE, SKILL_U_CRAFTINGPACK--[[, SKILL_STOWAGE]]}, TREE_BUILDINGTREE)
GM:AddSkill(SKILL_VISION, "Refiner's Vision", GOOD.."Locate nearby remantlers if behind walls\n"..GOOD.."Locate nearby unplaced remantlers on players through walls",
																6,			-4,					{SKILL_NONE, SKILL_ACUITY}, TREE_BUILDINGTREE)
...
GM:AddSkill(SKILL_INSIGHT, "Buyer's Insight", GOOD.."Locate nearby arsenal crates if behind walls\n"..GOOD.."Locate nearby unplaced arsenal crates on players through walls\n"..GOOD.."Locate nearby arsenal packs through walls",
																0,			-4,					{--[[SKILL_U_NANITECLOUD, SKILL_U_ZAPPER_ARC,]] SKILL_HAMMERDISCIPLINE, SKILL_LIGHTCONSTRUCT, SKILL_FIELDAMP, SKILL_TECHNICIAN--[[, SKILL_D_LATEBUYER]]}, TREE_BUILDINGTREE)
.AlwaysActive = true
...
GM:AddSkill(SKILL_TRIGGER_DISCIPLINE2, "Trigger Discipline II", GOOD.."+3% weapon reload speed\n"..GOOD.."+3% weapon draw speed",
																-4,			3,					{SKILL_TRIGGER_DISCIPLINE3, --[[SKILL_D_PALSY,]] SKILL_LEVELHEADED, SKILL_EQUIPPED}, TREE_GUNTREE)
...
GM:AddSkill(SKILL_FOCUSII, "Focus II", GOOD.."+4% tighter aiming reticule\n"..BAD.."-4% weapon reload speed",
																4,			3,					{SKILL_FOCUSIII, SKILL_SCAVENGER, --[[SKILL_D_PALSY,]] SKILL_LEVELHEADED, SKILL_PITCHER}, TREE_GUNTREE)
...
GM:AddSkill(SKILL_DELIBRATION, "Delibration", GOOD.."+1% tighter aiming reticule",
																6,			-3,					{}, TREE_GUNTREE)
GM:AddSkill(SKILL_EGOCENTRIC, "Egocentric", GOOD.."+25% reload speed\n"..GOOD.."-15% weapon spread\n"..GOOD.."+15% weapon draw speed\n"..BAD.."0% healing on others\n"..BAD.."0% repairs",
																0,			-1,					{SKILL_CANNONBALL, SKILL_CONEFFECT}, TREE_GUNTREE)
...
-- Zombie Tree
GM:AddSkill(SKILL_ZRIGOR1, "Rigor I", GOOD.."+1% maximum health as zombie\n",
																-4,			-4,					{SKILL_ZRIGOR2, SKILL_NONE}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZRIGOR2, "Rigor II", GOOD.."+2% maximum health as zombie\n",
																-3,			-3,					{SKILL_ZRIGOR3, SKILL_ZRIGOR1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZRIGOR3, "Rigor III", GOOD.."+3% maximum health as zombie\n",
																-2,			-2,					{SKILL_ZFURY1, SKILL_ZRIGOR2}, TREE_ZOMBIETREE)
																
GM:AddSkill(SKILL_ZMORTIS1, "Mortis I", GOOD.."+1% movement speed as zombie\n",
																-4,			4,					{SKILL_ZMORTIS2, SKILL_NONE}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZMORTIS2, "Mortis II", GOOD.."+2% movement speed as zombie\n",
																-3,			3,					{SKILL_ZMORTIS3, SKILL_ZMORTIS1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZMORTIS3, "Mortis III", GOOD.."+3% movement speed as zombie\n",
																-2,			2,					{SKILL_ZFURY1, SKILL_ZMORTIS2}, TREE_ZOMBIETREE)
																
GM:AddSkill(SKILL_ZROT1, "Rot I", GOOD.."+1% damage as zombie\n",
																4,			-4,					{SKILL_ZROT2, SKILL_NONE}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZROT2, "Rot II", GOOD.."+2% damage as zombie\n",
																3,			-3,					{SKILL_ZROT3, SKILL_ZROT1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZROT3, "Rot III", GOOD.."+3% damage as zombie\n",
																2,			-2,					{SKILL_ZENDURING1, SKILL_ZROT2}, TREE_ZOMBIETREE)
																
GM:AddSkill(SKILL_ZGRASP1, "Grasp I", GOOD.."+1% melee range as zombie\n",
																4,			4,					{SKILL_ZGRASP2, SKILL_NONE}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZGRASP2, "Grasp II", GOOD.."+2% melee range as zombie\n",
																3,			3,					{SKILL_ZGRASP3, SKILL_ZGRASP1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZGRASP3, "Grasp III", GOOD.."+3% melee range as zombie\n",
																2,			2,					{SKILL_ZENDURING1, SKILL_ZGRASP2}, TREE_ZOMBIETREE)
																
GM:AddSkill(SKILL_ZENDURING1, "Enduring I", GOOD.."+1% resistance as zombie\n",
																2,			0,					{SKILL_ZENDURING2, SKILL_ZGRASP3, SKILL_ZROT3}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZENDURING2, "Enduring II", GOOD.."+2% resistance as zombie\n",
																1,			-1,					{SKILL_ZENDURING3, SKILL_ZENDURING1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZENDURING3, "Enduring III", GOOD.."+3% resistance as zombie\n",
																0,			-2,					{SKILL_ZSUPERZOMBIE, SKILL_ZENDURING2}, TREE_ZOMBIETREE)
																
GM:AddSkill(SKILL_ZFURY1, "Fury I", GOOD.."+1% melee speed as zombie\n",
																-2,			0,					{SKILL_ZFURY2, SKILL_ZMORTIS3, SKILL_ZRIGOR3}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZFURY2, "Fury II", GOOD.."+2% melee speed as zombie\n",
																-1,			1,					{SKILL_ZFURY3, SKILL_ZFURY1}, TREE_ZOMBIETREE)
GM:AddSkill(SKILL_ZFURY3, "Fury III", GOOD.."+3% melee speed as zombie\n",
																 0,			2,					{SKILL_ZSUPERZOMBIE, SKILL_ZFURY2}, TREE_ZOMBIETREE)	
																
GM:AddSkill(SKILL_ZSUPERZOMBIE, "Super Zombie", GOOD.."The humans don't stand a chance\n"..GOOD.."4% boost to Zombie Stats\n" ,
																 0,			0,					{SKILL_ZENDURING3, SKILL_ZFURY3}, TREE_ZOMBIETREE)
...
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIEDAMAGE_MUL, function(pl, amount)
	pl.ZombieDamageMultiplier = math.Clamp(amount + 1.0, 0.05, 10.0)
end)
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIEHEALTH_MUL, function(pl, amount)
	pl.ZombieHealthMultiplier = math.Clamp(amount + 1.0, 0.05, 10.0)
end)
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIESPEED_MUL, function(pl, amount)
	pl.ZombieSpeedMultiplier = math.Clamp(amount + 1.0, 0.05, 10.0)
end)
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIERANGE_MUL, function(pl, amount)
	pl.ZombieRangeMultiplier = math.Clamp(amount + 1.0, 0.05, 10.0)
end)
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIERESISTANCE_MUL, function(pl, amount)
	pl.ZombieResistanceMultiplier = math.Clamp(amount + 1.0, 0.05, 100.0)
end)
GM:SetSkillModifierFunction(SKILLMOD_ZOMBIEATTACK_MUL, function(pl, amount)
	pl.ZombieAttackMultiplier = math.Clamp(amount + 1.0, 0.05, 100.0)
end)
...
GM:SetSkillModifierFunction(SKILLMOD_MELEE_SWING_SPEED_MUL, function(pl, amount)
	pl.MeleeSwingSpeedMul = math.Clamp(amount + 1.0, 0, 1000.0)
end)
...
GM:AddSkillModifier(SKILL_EGOCENTRIC, SKILLMOD_AIMSPREAD_MUL, -0.15)
GM:AddSkillModifier(SKILL_EGOCENTRIC, SKILLMOD_RELOADSPEED_MUL, 0.25)
GM:AddSkillModifier(SKILL_EGOCENTRIC, SKILLMOD_DEPLOYSPEED_MUL, 0.1)
GM:AddSkillModifier(SKILL_EGOCENTRIC, SKILLMOD_MEDKIT_EFFECTIVENESS_MUL, -2)
GM:AddSkillModifier(SKILL_EGOCENTRIC, SKILLMOD_REPAIRRATE_MUL, -2)
...
GM:AddSkillModifier(SKILL_BATTLER1, SKILLMOD_MELEE_SWING_SPEED_MUL, -0.01)
GM:AddSkillModifier(SKILL_BATTLER2, SKILLMOD_MELEE_DAMAGE_MUL, 0.05)
GM:AddSkillModifier(SKILL_BATTLER2, SKILLMOD_MELEE_SWING_SPEED_MUL, -0.02)
GM:AddSkillModifier(SKILL_BATTLER3, SKILLMOD_MELEE_DAMAGE_MUL, 0.05)
GM:AddSkillModifier(SKILL_BATTLER3, SKILLMOD_MELEE_SWING_SPEED_MUL, -0.03)
GM:AddSkillModifier(SKILL_BATTLER4, SKILLMOD_MELEE_DAMAGE_MUL, 0.06)
GM:AddSkillModifier(SKILL_BATTLER4, SKILLMOD_MELEE_SWING_SPEED_MUL, -0.04)
GM:AddSkillModifier(SKILL_BATTLER5, SKILLMOD_MELEE_DAMAGE_MUL, 0.07)
GM:AddSkillModifier(SKILL_BATTLER5, SKILLMOD_MELEE_SWING_SPEED_MUL, -0.05)
...
GM:AddSkillModifier(SKILL_PHASER, SKILLMOD_BARRICADE_PHASE_SPEED_MUL, 0.25)
GM:AddSkillModifier(SKILL_PHASER, SKILLMOD_SIGIL_TELEPORT_MUL, 0.5)

GM:AddSkillModifier(SKILL_DRIFT, SKILLMOD_BARRICADE_PHASE_SPEED_MUL, 0.1)

GM:AddSkillModifier(SKILL_WARP, SKILLMOD_SIGIL_TELEPORT_MUL, -0.15)
...
GM:AddSkillModifier(SKILL_RECLAIMSOL, SKILLMOD_MEDGUN_RELOAD_SPEED_MUL, -0.25)
...
GM:AddSkillModifier(SKILL_AGILEII, SKILLMOD_SPEED, -2)

GM:AddSkillModifier(SKILL_AGILEIII, SKILLMOD_JUMPPOWER_MUL, 0.06)
GM:AddSkillModifier(SKILL_AGILEIII, SKILLMOD_SPEED, -3)
...
GM:AddSkillModifier(SKILL_DISPERSION, SKILLMOD_CLOUD_RADIUS, 0.25)
...
GM:AddSkillModifier(SKILL_ZRIGOR1, SKILLMOD_ZOMBIEHEALTH_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZRIGOR2, SKILLMOD_ZOMBIEHEALTH_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZRIGOR3, SKILLMOD_ZOMBIEHEALTH_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZMORTIS1, SKILLMOD_ZOMBIESPEED_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZMORTIS2, SKILLMOD_ZOMBIESPEED_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZMORTIS3, SKILLMOD_ZOMBIESPEED_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZROT1, SKILLMOD_ZOMBIEDAMAGE_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZROT2, SKILLMOD_ZOMBIEDAMAGE_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZROT3, SKILLMOD_ZOMBIEDAMAGE_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZGRASP1, SKILLMOD_ZOMBIERANGE_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZGRASP2, SKILLMOD_ZOMBIERANGE_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZGRASP3, SKILLMOD_ZOMBIERANGE_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZENDURING1, SKILLMOD_ZOMBIERESISTANCE_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZENDURING2, SKILLMOD_ZOMBIERESISTANCE_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZENDURING3, SKILLMOD_ZOMBIERESISTANCE_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZFURY1, SKILLMOD_ZOMBIEATTACK_MUL, 0.01)

GM:AddSkillModifier(SKILL_ZFURY2, SKILLMOD_ZOMBIEATTACK_MUL, 0.02)

GM:AddSkillModifier(SKILL_ZFURY3, SKILLMOD_ZOMBIEATTACK_MUL, 0.03)

GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIEHEALTH_MUL, 0.04)
GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIESPEED_MUL, 0.04)
GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIEDAMAGE_MUL, 0.04)
GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIERANGE_MUL, 0.04)
GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIERESISTANCE_MUL, 0.04)
GM:AddSkillModifier(SKILL_ZSUPERZOMBIE, SKILLMOD_ZOMBIEATTACK_MUL, 0.04)
